...
with open('/Users/ritayanbanerjee/Desktop/SearchAlgorithms/LearningAlgorithms/train.csv') as f:
    reader = csv.reader(f)
    next(reader)
    data_train = []
    for row in reader:
...
with open('/Users/ritayanbanerjee/Desktop/SearchAlgorithms/LearningAlgorithms/test.csv') as f:
    reader = csv.reader(f)
    next(reader)
    data_test = []
    for row in reader:
